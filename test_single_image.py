    ...
    for idx in range(images.shape[0]):
        ...
        if vis_dir is not None:
            ...
            img_save_path = os.path.join(
                vis_dir, "{}_pred{}.jpg".format(name, len(pred[idx]))
            )
...
def evaluate_single_image(model, img_path, device, vis_dir=None):
    ...
    if vis_dir:
        points = [
            [point[0] * img_h, point[1] * img_w] for point in outputs_points
        ]  # recover to actual points
        split_map = (
            (outputs["split_map_raw"][0].detach().cpu().squeeze(0) > 0.5)
            .float()
            .numpy()
        )
...
def main(args):
    ...
    args.img_path = "/home/tiennv/FPT/yolov9/APGCC/black_guy/test1_time/images/465677790_8877048909000458_7116522921310714162_n.jpg"
    args.resume = "/home/tiennv/FPT/yolov9/PET/JHU_Crowd.pth"
    args.vis_dir = "/home/tiennv/FPT/yolov9/PET/vis_output"
